...
Krill can also be set up as a highly available, scalable service using
:ref:`doc_krill_manager`.  A 1-Click App on the DigitalOcean and AWS Marketplaces can set
